...
- **OQ-9** — Is there a visualization layer (browser, reusing the owner's loupe experience) or is v1 headless-sim + CLI/plots only? *Open — affects stack choice; recommend headless testable core first, viz optional later.*
